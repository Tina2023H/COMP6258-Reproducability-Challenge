...
class ShapesDataset(Dataset):
    def __init__(self, opt: DictConfig, partition: str) -> None:
        ...
        # Un-comment this for Loop for label flipping
        '''
        for i in range(int(len(dataset["labels"])/4)):
            dataset["labels"][i][0][0] = 1 - dataset["labels"][i][0][0]
        '''
        ...
        #print('len(dataset["labels"][0]:',len(dataset["labels"][0]))
        #print('len(dataset["labels"][0][0]):',len(dataset["labels"][0][0]))
        #print('dataset["labels"][0][0][0]:',dataset["labels"][0][0][0])
...
#*************************************************************************************
class ShapesDataset_test(Dataset):
    def __init__(self, opt: DictConfig, partition: str) -> None:
        """
        Initialize the 4Shapes datasets.
        ...
        Args:
            ...
            partition (str): Dataset partition ("train", "val", or "test").
        """
        super(ShapesDataset_test, self).__init__()
