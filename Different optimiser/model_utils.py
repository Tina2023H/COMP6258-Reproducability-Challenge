...
def get_model_and_optimizer(
    ...
    optimizer = torch.optim.Adadelta(
        model.parameters(),
        lr=opt.training.learning_rate,  # Adadelta typically does not require a learning rate
        rho=0.9,  # Decay rate rho
        weight_decay=opt.training.weight_decay,
        eps=1e-06  # Smoothing term to avoid division by zero
    )
